        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('notes.index') }}" class="text-sm text-indigo-600 hover:underline">View all notes &rarr;</a>
                </div>
                ...
                @if ($myNotes->isEmpty())
                    <p class="text-sm text-gray-500">You haven't uploaded any notes yet.
                        <a href="{{ route('notes.create') }}" class="text-indigo-600 hover:underline">Upload your first note</a>.
                    </p>
                @else
